...
```
<center>
![CQ observations and predictions from both models](data/CQ_plot_234201B.png){width=50%}
</center>
```
...
```
<center>
![Example of timeseries figure on one-page of PDF exported](data/CQ_timeseries_234201B_1994.png){width=70%}
</center>
